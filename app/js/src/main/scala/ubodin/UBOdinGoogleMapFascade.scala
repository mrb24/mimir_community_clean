...
@js.native @JSName("google.maps.MapOptions")
class GMapOptions(center: GLatLng, zoom: Int) extends js.Object
...
class GMap(node: TopNode, options: js.Dynamic) extends js.Object {
  ...
  def setOptions(mapOptions:js.Dynamic): Unit = js.native
}

@js.native @JSName("MarkerClusterer")
class GMarkerClusterer(map: GMap, markers:js.Array[GMarker], options: js.Dynamic) extends js.Object {
...
class GMarker(ops: js.Dynamic) extends js.Object {
  ...
  def setIcon(icon: js.Dynamic): Unit = js.native
}
...
case class Marker(position: LatLng, title: String = "", icon: Icon = null, shape: Shape = null, fillColor: String = null,  zIndex: Int = 0, draggable: Boolean = false, content: String = "") {
